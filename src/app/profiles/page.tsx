            ...
            <div className="flex items-center justify-between p-4 border-b-2 border-border bg-muted/30">
              ...
              {editingId !== "new" && (
                <Button
                  onClick={startNew}
                  size="sm"
                  className="bg-secondary text-secondary-foreground hover:bg-foreground hover:text-background"
                >
                  + 새 프로필
                </Button>
              )}
            ...
            <ul>
              {profiles.map((slot) => {
                ...
                return (
                  <li
                    key={slot.id}
                    className={`border-b border-border p-5 ${isActive ? "bg-secondary/5 border-l-4 border-l-secondary" : "border-l-4 border-l-transparent"}`}
                  >
                    {!isEditingThis && (
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-1.5">
                            ...
                            <h3 className="font-heading text-lg font-bold truncate">{slot.label}</h3>
                          </div>
...
function ProfileEditor({
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-2">
          <label className="text-[10px] font-bold uppercase tracking-widest">학력</label>
          <Input
        ...
        <div className="space-y-2">
          <label className="text-[10px] font-bold uppercase tracking-widest">자기소개</label>
          <Input
