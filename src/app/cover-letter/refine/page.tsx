    ...
    >
      <div className="max-w-6xl mx-auto space-y-0">
        <FadeIn>
          <Link
            href="/cover-letter"
            className="inline-flex items-center gap-2 text-xs uppercase tracking-widest text-muted-foreground hover:text-foreground transition-colors duration-75 mb-8"
          >
            ← 초안으로 돌아가기
          </Link>
          <div className="mb-12">
