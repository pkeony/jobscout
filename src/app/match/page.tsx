...
function ProfileForm({
 ...
 <span className=" font-black text-7xl">MATCH</span>
 </div>
 </div>
 </div>
 </>
...
function MatchSkeleton() {
 ...
 <div className="w-48 h-48 bg-muted border-4 border-border" />
 </div>
 <div className="grid grid-cols-1 md:grid-cols-2 gap-0 border-t-4 border-border">
 ...
 <Skeleton className="h-6 w-24" />
 {Array.from({ length: 3 }).map((_, i) => (
 <div key={i} className="p-4 bg-card/60 border-l-4 border-border space-y-2">
 <Skeleton className="h-4 w-32" />
 <Skeleton className="h-4 w-full" />
 </div>
 ))}
...
export default function MatchPage() {
 ...
 {allSlots.length > 0 && (
 <div className="mb-6 flex flex-col sm:flex-row sm:items-center gap-3 p-4 border-2 border-border bg-muted/30">
 ...
 className="flex-1 min-w-0 bg-card border-2 border-border px-3 py-2 text-sm font-medium focus:border-secondary focus:outline-none"
 >
 {allSlots.map((slot) => (
 ...
 <Link
 href="/profiles"
 className="text-xs text-muted-foreground hover:text-foreground underline decoration-dotted underline-offset-4 shrink-0"
 >
 프로필 관리 →
 </Link>
 </div>
 ...
 <span className=" font-black text-8xl">GAP</span>
 </div>
 </div>
 </div>
 </FadeIn>
 ...
 className="bg-accent text-accent-foreground px-10 py-6 text-sm font-bold hover:bg-foreground hover:text-background transition-colors duration-75 h-auto"
 >
 자소서 생성하기
 ...
 <button
 onClick={() => router.push("/cover-letter")}
 className="p-6 bg-muted border-2 border-border hover:border-secondary text-left transition-all duration-75 hover:-translate-y-0.5"
 >
 <span className="text-[10px] font-bold text-accent">01</span>
 <h4 className=" text-lg font-bold mt-2 mb-1">자소서 생성</h4>
 ...
 className="p-6 bg-muted border-2 border-border hover:border-secondary text-left transition-all duration-75 hover:-translate-y-0.5"
 >
 <span className="text-[10px] font-bold text-accent">02</span>
 <h4 className=" text-lg font-bold mt-2 mb-1">면접 예상질문</h4>
 ...
 <p className="text-[10px] text-accent font-bold mb-3">
 원문 출력
 </p>
 <pre className="whitespace-pre-wrap text-sm bg-muted p-4">
 {fullText}
 </pre>
 </div>
 </FadeIn>
