...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col bg-background">
      ...
      {/* Login Canvas */}
      <div className="flex-1 flex items-center justify-center relative dot-matrix-texture p-4">
        ...
        <div className="absolute left-12 top-1/2 -translate-y-1/2 hidden xl:block w-64 opacity-[0.15] pointer-events-none">
          ...
          <p className="text-[10px] mt-4 tracking-wider uppercase text-primary/40">
        ...
        <div className="relative w-full max-w-[480px]">
          ...
          <div className="relative bg-background border-4 border-primary p-8 md:p-12 shadow-[8px_8px_0px_0px_rgba(3,22,50,0.1)]">
            ...
            <header className="mb-10 space-y-2">
              ...
              <h1 className="font-heading font-black text-4xl tracking-tighter text-primary uppercase leading-none">
                JobScout
              </h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-2">
                ...
                >
                  <span>이메일</span>
                  <span className="text-secondary/60">필수</span>
                </label>
                <input
                  id="email"
                  type="email"
                  ...
                  className="w-full bg-muted border-b-2 border-primary/20 focus:border-primary outline-none py-3 px-0 text-primary placeholder:text-primary/20 transition-colors duration-100"
                />
              </div>
              ...
              <div className="pt-4 flex flex-col gap-6">
                <button
                  type="submit"
                  className="group relative w-full bg-primary text-primary-foreground py-5 font-bold uppercase tracking-[0.3em] text-sm overflow-hidden transition-all active:scale-[0.98]"
                >
                ...
                <div className="flex items-center justify-between text-[10px] font-bold uppercase tracking-wider text-muted-foreground">
                  <Link
                    href="#"
                    className="hover:text-secondary border-b border-transparent hover:border-secondary transition-all"
                  >
                    회원가입
                  </Link>
      ...
      <footer className="w-full bg-muted border-t-2 border-primary py-8 px-12 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="flex gap-6">
          <Link
            href="/"
            className="text-[10px] uppercase text-primary/60 hover:text-secondary transition-colors"
          >
            홈으로
          </Link>
          <Link
