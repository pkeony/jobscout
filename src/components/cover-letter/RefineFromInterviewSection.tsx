...
"jobscout:coverLetterImproveResult",
 ...
 <Link
 href="/interview"
 className="inline-block bg-accent text-accent-foreground px-4 py-2 text-xs font-bold hover:opacity-90"
 >
 면접 질문 생성하러 가기 →
 </Link>
 )}
 ...
 className={`px-4 py-2 text-xs font-bold border-2 transition-all duration-75 ${
 active
 ?"bg-accent text-accent-foreground border-secondary"
 ...
 {w.relatedHeading && (
 <span className="text-[10px] bg-muted px-1.5 py-0.5 text-muted-foreground">
 {w.relatedHeading}
 </span>
 )}
 </div>
 ...
 <span className=" font-black text-7xl">TRACE</span>
 </div>
 </div>
 );
}
