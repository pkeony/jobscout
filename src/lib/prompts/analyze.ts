...
export const PROMPT_VERSION = "analyze@v1.1.0-2026-04-19";
...
- **주요 응용 도메인/대상 키워드** — JD 가 특정 도메인을 중심으로 하면 그 도메인 명도 skill 로 추출. 예: "영상", "이미지", "음성", "자연어", "검색", "추천", "광고", "금융", "커머스", "헬스케어", "물류". 원문에 해당 단어가 명시적으로 반복·강조되는 경우에만. context 에는 "도메인 대상" 임을 명시.
