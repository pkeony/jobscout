...
export const PROMPT_VERSION = "interview@v1.1.0-2026-04-19";
  ...
  "questions": [
    {
      ...
      "sampleAnswer": "모범 답변 (STAR 라벨 포함, 7-10문장, 구체적 사례·수치 포함)"
    }
  ],
  "tips": ["팁1", "팁2", "팁3", "팁4"]
}
...
- **sampleAnswer**: STAR(Situation·Task·Action·Result) 구조, **7-10문장**, 구체 수치나 결과 포함. 각 단계를 **[Situation] [Task] [Action] [Result]** 라벨로 문단 앞에 붙여 구분하세요. 라벨 없이 서술만 쭉 이어 쓰면 안 됩니다. 7문장보다 짧으면 면접관이 후속 질문으로 파고들 만한 구체성이 부족합니다.
  - 예시 형식:
