...
export const PROMPT_VERSION = "interview@v1.2.0-2026-04-19";
  ...
  "questions": [
    {
      ...
      "sampleAnswer": "모범 답변 (STAR 라벨 포함, 정확히 7~10문장, 6문장 이하 금지, 구체적 사례·수치 포함)"
    }
  ],
  "tips": ["팁1", "팁2", "팁3", "팁4"]
}
...
5) tips.length == 4
6) 모든 questions[i].sampleAnswer 문장 수 >= 7 (마침표·물음표·느낌표 기준). 하나라도 6문장 이하면 재작성
...
- **sampleAnswer**: STAR(Situation·Task·Action·Result) 구조, **정확히 7~10문장 (6문장 이하 금지, 11문장 이상 장황함 감점)**, 구체 수치나 결과 포함. 각 단계를 **[Situation] [Task] [Action] [Result]** 라벨로 문단 앞에 붙여 구분하세요. 라벨 없이 서술만 쭉 이어 쓰면 안 됩니다. 7문장보다 짧으면 면접관이 후속 질문으로 파고들 만한 구체성이 부족하므로 **반드시 7문장 이상** 작성하세요. 문장 수 카운트는 마침표·물음표·느낌표 기준.
  - 예시 형식:
    "[Situation] <1-2 문장: 어떤 상황/팀에서>. [Task] <1-2 문장: 맡은 역할/해결 과제>. [Action] <2-4 문장: 구체적 기술·의사결정·실행>. [Result] <2-3 문장: 수치/결과/학습>."
- **intent**: 1문장으로 압축.`;
