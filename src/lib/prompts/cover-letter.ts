...
export const PROMPT_VERSION = "cover-letter@v1.0.0-2026-04-19";
...
각 섹션의 paragraphs는 2~3개 문단. 각 문단은 가급적 STAR 구조(Situation → Task → Action → Result)로 전개하세요. 구체적 수치/결과를 포함하되 프로필에 없는 사실(회사명·숫자·직책 등)은 만들어내지 마세요.
